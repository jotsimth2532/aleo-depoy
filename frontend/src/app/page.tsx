...
const TickerItem = () => (
  <div className="flex items-center space-x-12 px-6">
    ...
    <span className="text-2xl md:text-4xl font-black uppercase tracking-widest text-white">Zero Knowledge</span>
    <span className="w-3 h-3 rounded-full bg-white"></span>
    <span
      className="text-2xl md:text-4xl font-black uppercase tracking-widest text-transparent transition-colors hover:text-white"
      style={{ WebkitTextStroke: "1px rgba(255,255,255,0.3)" }}
    ...
    <span className="w-3 h-3 rounded-full bg-white"></span>
    <span className="text-2xl md:text-4xl font-black uppercase tracking-widest text-white">Confidential Compute</span>
    <span className="w-3 h-3 rounded-full bg-white"></span>
    <span
      className="text-2xl md:text-4xl font-black uppercase tracking-widest text-transparent transition-colors hover:text-white"
      style={{ WebkitTextStroke: "1px rgba(255,255,255,0.3)" }}
    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans overflow-x-hidden">
      ...
      <main className="relative z-10 w-full">
        <section className="max-w-[1400px] mx-auto px-6 pt-8 md:pt-12 min-h-[85vh] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24 relative">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-start text-left max-w-2xl relative z-20">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5, delay: 0.5 }} className="hidden lg:block relative w-full h-[600px]">
            <Hero3D />
        ...
        <div className="w-full overflow-hidden border-y border-white/5 bg-white/5 py-8 mb-40 flex relative z-10">
          <motion.div animate={{ x: [0, -2000] }} transition={{ repeat: Infinity, ease: "linear", duration: 30 }} className="flex whitespace-nowrap">
            <TickerItem />
            <TickerItem />
            <TickerItem />
            <TickerItem />
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} id="features" className="max-w-[1400px] mx-auto px-6 mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="p-10 border border-white/10 bg-black hover:bg-neutral-900/50 hover:border-white/40 transition-all duration-300 group cursor-default">
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} id="ecosystem" className="max-w-[1400px] mx-auto px-6 mb-40">
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} id="docs" className="max-w-[1400px] mx-auto px-6 mb-40">
          <div className="border border-white/10 bg-black p-12 lg:p-24 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div variants={fadeIn}>
                ...
                <Link href="/whitepaper" className="border border-white bg-white text-black hover:bg-transparent hover:text-white px-8 py-4 font-semibold transition-all flex items-center justify-center space-x-3">
